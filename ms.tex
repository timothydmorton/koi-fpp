...
\tablecaption{\vespa--calculated FPPs of the \\Santerne (2015) RV sample
  \tablabel{santerne}}
\tablehead{\colhead{nature} & \colhead{mean FPP} & \colhead{median FPP}}
\startdata
...
These calculations depend largely on the results of
\citet{Bryson:KSCI}, which quantify the probability that the
eclipse/transit signal is spatially coincident on the sky with the
