...
\kepler\ candidates, including .  More recently, the PASTIS analysis suite has
been introduced \citep{Diaz:2014} and applied to both \kepler\ and 

Two
examples of validation procedures that have been used in the
literature are ``Blender'' that has been used in the validation of
many \kepler\ planets, and PASTIS, which has also been used 
...
section.  The procedure as implemented here is publicly available in
the Python module
