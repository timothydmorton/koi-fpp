...
mission \citep{Montet:2015,Becker:2015,Schlieder:2015}.  The code that
implements this procedure is now publicly available in the Python
module \vespa\footnote{\url{https://github.com/timothydmorton/vespa}}
\citep{vespa}.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Comparison with follow-up observations}
\sectlabel{comparisons} One of the difficulties with probabilistic
...
that about 8\% of their observed candidates are likely to be false
positives.  Of these 50 candidates, \vespa\ on its own calculates FPP
$\gt$ 0.1 for four.  Two of these (KOI-103.01 and KOI-248.02) are
...
respectively.  All but two of the remaining canidates have FPP $\lt$
0.01.  
