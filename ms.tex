...
CONFIRMED.  \Fig{fpppie} shows a different kind of summary, setting
aside those with CONFIRMED and FALSE POSITIVE dispositions and
...
\caption{False positive probabilities of all CANDIDATE or CONFIRMED
  ...
  \nval\ have FPPs less than 1\%.  Noteably, \nreliableFP\ are likely
...
\caption{A summary of how the the calculations presented in this paper
  ...
  with reliable calculations, grouped by false positive probability.
  \nvalnew\ of these are new planet validations, and \nfpnew\ are new
  likely false positives.  \figlabel{fpppie}}
\end{figure*}
