...
``boxy'' and ``long'' models in the model selection calculation
 (\sect{mothods:fpp}) is to flag signals that do not 
fit well with any of the astrophysical eclipse models---and despite their
contrived nature, they do seem to 
